...
- [x] (Optional) Additional randomly-selected background scenery
...
I had issues with this activity because in the beggining, by mistake, I didn't selected the "for my own purposes" option, which made me lost the code and had a lot of problems. Thankfully, I was able to meet with the Professor and fix this problem. Next time, I will look more closely what I select before an activity. 



**What challenges did you face, and how did you overcome them?**
Knowing how to properly work with the Java functionality. Trying to solve this problem, I looked at many videos and discovered more about Java. 


**What is something that was interesting or exciting, or a lesson you learned
  from this experience that you want to remember?**
Whenever I need help, I can always ask for it. I do not need to struggle in silence when there are a lot of support resoruces available for me. 